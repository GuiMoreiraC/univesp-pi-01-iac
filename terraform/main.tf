    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:s3:::conteudo-audiovisual-data/*"
      },
      {
        Effect   = "Allow",
...
locals {
  routes = {
    ...
    "POST /history"        = "history_post"
    "DELETE /history/{id}" = "history_delete"
    "POST /preferences"    = "preferences_post"
    "GET /recommendations" = "recommendations_get"
    "GET /releases"        = "releases_get"
  }
}
